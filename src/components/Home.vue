        ...
        <el-container>
          ...
          <ul class="nav">
            <li class="nav-item" index="1">
              <el-button size="medium">登入</el-button>
            </li>
            <li class="nav-item" index="2">
              <el-button size="medium" type="primary">註冊</el-button>
            </li>
            <li class="nav-item" index="3">
              <template>
                <el-dropdown class="langSelect" size="medium" trigger="click" @command="changeLang">
        ...
        <div class="footer-container">
          <div class="footer-about">
            <div class="footerItem contact">
              <h3>联系我们</h3>
              <p>咨询電話：0571 - 8685 7988</p>
              <p>周一到周日 9:00 ~ 18:00</p>
            </div>
            <div class="footerItem about">
              <h3>关于我们</h3>
              <p>
                <a href="#" target="_blank">中国稷風</a>
              </p>
              <p>
                <a href="#">公司文化</a>
              </p>
              ...
              <div class="qr-code">
                <div class="cmpCode"></div>
              </div>
            </div>
            <div class="footerItem product">
              <h3>产品与服务</h3>
              <p>
                <a href="/intro/wsc">稷風官網</a>
                <a href="/intro/ls">CRP</a>
              </p>
              <p>
                <a href="/intro/weapp">供應商平台</a>
              </p>
            </div>
            <div id="news" class="footerItem" style="float:right;">
              <h3>公司动态</h3>
              <p>
                <a
                  href="https://h5.youzan.com/appcms/detail.html?alias=3enzcb732vqaw"
                  target="_blank"
                >公告｜有赞一贯遵循法律合法经营</a>
              </p>
              <p>
                <a
                  href="https://baijiahao.baidu.com/s?id=1629749200420940563&amp;wfr=spider&amp;for=pc"
                  target="_blank"
                >钛媒体｜有赞完成新一轮近10亿融资，用于推进门店互联网化</a>
              </p>
              <p>
                <a
                  href="https://baijiahao.baidu.com/s?id=1627257716283852571&amp;wfr=spider&amp;for=pc"
                  target="_blank"
                >亿邦｜有赞小程序接入“好物圈” 为商家增加曝光</a>
              </p>
              <p>
                <a
                  href="http://www.ebrun.com/20190130/319146.shtml?eb=hp_home_lcol_xtt"
                  target="_blank"
                >亿邦｜引入5万开发者 有赞云帮商家实现“店铺定制组装”</a>
              </p>
              <p>
                <a
                  href="http://www.redsh.com/corp/20190124/174033.shtml"
                  target="_blank"
                >红商｜互联网品牌怎么玩有赞？从舒淇的“KiKi面”说起</a>
              </p>
            </div>
          </div>
          <div class="commonCopy">
            <p>
              <a href="/intro/ipr">法律聲明及隱私受權</a>
